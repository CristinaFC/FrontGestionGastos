...
const Style = {
    ...
    DEVICE_FIVE_PERCENT_WIDTH: x * 0.05,
    DEVICE_TEN_PERCENT_WIDTH: x * 0.1,
    DEVICE_TWENTY_PERCENT_WIDTH: x * 0.2,
    DEVICE_FORTY_PERCENT_WIDTH: x * 0.4,
    DEVICE_FORTY_FIVE_PERCENT_WIDTH: x * 0.45,
    DEVICE_SEVENTY_FIVE_PERCENT_WIDTH: x * 0.75,
    DEVICE_EIGHTY_PERCENT_WIDTH: x * 0.8,
    DEVICE_NINETY_PERCENT_WIDTH: x * 0.9,
    DEVICE_NINETY_FIVE_PERCENT_WIDTH: x * 0.95,
    DEVICE_HEIGHT: y,
    DEVICE_FIVE_PERCENT_HEIGHT: y * 0.05,
    DEVICE_SEVEN_PERCENT_HEIGHT: y * 0.07,
    DEVICE_TEN_PERCENT_HEIGHT: y * 0.1,
    DEVICE_FIFTY_PERCENT_HEIGHT: y * 0.15,
    DEVICE_TWENTY_PERCENT_HEIGHT: y * 0.2,
    ...
    DEVICE_EIGHTY_PERCENT_HEIGHT: y * 0.8,
    DEVICE_NINETY_PERCENT_HEIGHT: y * 0.9,
