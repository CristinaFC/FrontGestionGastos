...
import { apiGetExpensesByAccountPerMonth, clearGraphData } from '../../../modules/Graph/GraphActions';
...
const mapStateToPropsAction = {
    apiGetExpensesByAccount: apiGetExpensesByAccountPerMonth,
    clearGraphData
};


export default connect(mapStateToProps, mapStateToPropsAction)(ExpensesByAccountPerMonthGraphScreen);
