        ...
        return (
            <SafeAreaView style={Views.container}>                <Header goBack={true} title="Gráficos" />
                <ImageBackground source={localAssets.background} resizeMode="cover" style={Views.image} blurRadius={40}>
                    ...
                    {/* <View style={{ width: "100%", height: "10%", alignItems: "center", flexDirection: 'column' }}>
                        <MenuButton title="Mes y año" onPress={() => RootRouting.navigate(Routing.incomesByYearGraphScreen)} />
                    </View> */}
                    <View style={{ width: "100%", height: "10%", alignItems: "center", flexDirection: 'column' }}>
                        <MenuButton title="Método de pago" onPress={() => RootRouting.navigate(Routing.incomesByAccountAndDateGraphScreen)} />
                    </View>
                    {/* 
                    <View style={{ width: "100%", height: "10%", alignItems: "center", flexDirection: 'column' }}>
                        <MenuButton title="Comparación por fechas" onPress={() => RootRouting.navigate(Routing.incomesDatesComparationGraphScreen)} />
                    </View> */}
